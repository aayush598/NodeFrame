...
export const BuildAppNode: React.FC<NodeProps<CustomNodeData>> = ({ id: _id, data, selected, isConnectable }) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2 mb-2">
                ...
                >
                    {data.icon || <Code className="w-4 h-4 text-white" />}
                </div>
                <div className="flex-1">
                    <div className="font-semibold text-sm text-gray-900">{data.label || 'Build App'}</div>
